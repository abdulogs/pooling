    ...
    foreach ($routes as $route) { ?>
      <tr>
        ...
        <td class="align-middle px-3" data-label="Controls">
          <a class="updateBtn ti-pencil mr-1 font-16 text-success" data-id="<?php echo $route["id"]; ?>" href="javascript:void(0)" title="Update"></a>
          <a class="deleteBtn ti-trash mr-1 font-16 text-danger"  data-id="<?php echo $route["id"]; ?>" href="javascript:void(0)" title="Delete"></a>
        </td>
      </tr>
    <?php } ?>
    <tr id="loader"></tr>
