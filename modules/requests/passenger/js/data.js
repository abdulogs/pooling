$(document).ready(function () {
  function loadData(page) {
    $.ajax({
      url: "modules/requests/passenger/data.php",
      method: "POST",
      data: {
        page: page
      },
      cache: false,
      beforeSend: function () {
               $('#loader').html(`<td colspan="9" class="text-center">Loadind...</td>`);
      },
  ...
  $(document).on('click', '.updateBtn', function (e) {
    var id = $(this).data('id');
    $.ajax({
      url: "modules/requests/passenger/form.php",
      type: "POST",
      data: {
        id: id
      },
  ...
  $(document).on("submit", "#update", function (e) {
    e.preventDefault();
    $.ajax({
      url: "modules/requests/passenger/update.php",
      type: 'post',
  ...
  $(document).on('click', '.deleteBtn', function (e) {
    if (confirm("Do you really want to delete this!")) {
      var id = $(this).data('id');
      $.ajax({
        url: "modules/requests/passenger/delete.php",
        type: 'post',
        data: {
          id: id
        },
