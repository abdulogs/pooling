      ...
      <div class="container-fluid">
          ...
          <div class="d-flex align-items-center px-3 py-2 border-bottom">
              <h4 class="m-0 font-20 align-middle">
                <i class="fa fa-car text-success"></i> Vehicles
              </h4>
            </div>
            ...
            <table class="table table-card table-sm mb-0">
              <thead class="bg-light border-top">
                <tr>
                  ...
                  <th class="border-0" scope="col">Brand</th>
                  <th class="border-0" scope="col">Color</th>
                  <th class="border-0" scope="col">Seats</th>
                  <th class="border-0" scope="col">Model</th>
                  <th class="border-0" scope="col">Reg number</th>
