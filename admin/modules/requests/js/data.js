$(document).ready(function () {
  function loadData(page) {
    $.ajax({
      ...
      cache: false,
      beforeSend: function () {
        $('#loader').html(`<td colspan="11" class="text-center">Loadind...</td>`);
      },
  ...
  $(document).on('submit', '#create', function (e) {
    e.preventDefault();
    $.ajax({
      url: "modules/requests/create.php",
      type: 'post',
  ...
  $(document).on("submit", "#update", function (e) {
    e.preventDefault();
    $.ajax({
      url: "modules/requests/update.php",
      type: 'post',
      data: new FormData(this),
      contentType: false,
      processData: false,
  ...
  $(document).on('click', '.deleteBtn', function (e) {
    if (confirm("Do you really want to delete this!")) {
      var id = $(this).data('id');
      $.ajax({
        url: "modules/requests/delete.php",
        type: 'post',
        data: {
          id: id
        },
